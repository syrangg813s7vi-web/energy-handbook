...
如果当前阅读器没有显示动画，可以
[单独打开柴油机组接入演示](../demos/iec61850/diesel-device-onboarding)。
...
如果当前阅读器没有显示动画，可以
[单独打开统一模型信息传递演示](../demos/iec61850/diesel-unified-model-information-flow)。
...
如果当前阅读器没有显示动画，可以
[单独打开启动命令映射演示](../demos/iec61850/diesel-control-mapping-table)。
...
如果当前阅读器没有显示动画，可以
[单独打开当前功率获取演示](../demos/iec61850/diesel-current-power-flow)。
...
如果当前阅读器没有显示动画，可以
[单独打开柴发标准控制演示](../demos/iec61850/diesel-standard-model-control)。
