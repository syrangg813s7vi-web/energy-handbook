...
description: 用交互动画理解并网点数据选择、光伏均衡、标幺值、过调检测和光伏储能变量分配的基本控制思想。
---
...
3. 上层控制器计算所需的场站调节量；
4. 光伏储能变量分配决定光伏和储能各自承担多少；
5. 光伏均衡把光伏侧指令分给仍有能力和裕度的单元；
6. 光伏逆变器和储能变流器共同执行，并网点功率上升；
7. 过调检测判断是否持续越过目标；
8. 若确认过调，控制器采取冻结积分、减小指令等处置。
