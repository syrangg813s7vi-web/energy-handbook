...
<template>
  <div class="config-demo grid-switch-demo" :class="{ fault:step===6 }">
    ...
    <div class="switch-stage">
      <svg viewBox="0 0 736 350" preserveAspectRatio="none" role="img" aria-labelledby="switch-title">
...
<style scoped>
.switch-stage{position:relative;min-height:350px;aspect-ratio:736/350}.switch-stage svg{position:absolute;inset:0;width:100%;height:100%}.wire{fill:none;stroke:var(--config-accent);stroke-width:2}.wire.right{stroke:var(--config-line);stroke-dasharray:7 5}.wire.right.active{stroke:var(--config-accent);stroke-dasharray:none}.packet{r:5;fill:var(--config-accent)}.node{position:absolute;box-sizing:border-box;display:flex;flex-direction:column;justify-content:center;gap:4px;min-height:82px;padding:11px;border:1px solid var(--config-line);border-radius:10px;background:var(--config-node);transform:translateY(-50%);transition:.4s}.node span,.node small{color:var(--vp-c-text-2)}.grid{top:57.14%;left:0;width:19.7%}.logic{top:20%;left:38%;width:24%}.breaker{top:57.14%;left:38%;width:24%;text-align:center}.island{top:57.14%;right:0;width:19.7%}.logic.permitted,.breaker.closed{border-color:var(--config-accent);background:var(--config-accent-soft)}.fault .logic,.fault .breaker{border-color:var(--config-danger);color:var(--config-danger)}.sync-window{position:absolute;left:24%;right:24%;bottom:18px;display:grid;grid-template-columns:auto 1fr auto;gap:10px;align-items:center;color:var(--vp-c-text-2)}.sync-window>div{height:10px;overflow:hidden;border-radius:999px;background:var(--config-track)}.sync-window i{display:block;height:100%;background:var(--config-accent);transition:width .6s var(--config-ease)}
@media(max-width:680px){.switch-stage{display:grid;grid-template-columns:1fr 1fr;gap:10px;min-height:0;aspect-ratio:auto}.switch-stage svg{display:none}.node{position:static;width:auto;min-height:92px;transform:none}.grid{order:1}.island{order:2}.logic{order:3}.breaker{order:4}.sync-window{position:static;grid-column:1/-1;order:5}}
