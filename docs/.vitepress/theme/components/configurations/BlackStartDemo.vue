...
<template>
  <div class="config-demo black-start-demo">
    ...
    <div class="black-stage">
      <svg viewBox="0 0 736 330" preserveAspectRatio="none" role="img" aria-labelledby="black-title"><title id="black-title">场站从无压状态逐级黑启动</title>
