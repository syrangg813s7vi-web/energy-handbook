...
<template>
  <div class="config-demo fault-record-demo">
    ...
    <div class="record-stage">
      <svg viewBox="0 0 736 300" role="img" aria-labelledby="record-title"><title id="record-title">故障录波的触发前后记录流程</title>
