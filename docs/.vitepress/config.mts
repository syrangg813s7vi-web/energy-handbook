    ...
    nav: [
      { text: "首页", link: "/" },
      {
        ...
        items: [
          ...
          { text: "西门子新能源方案矩阵", link: "/insights/siemens-power-plant-product-list" },
          ...
          { text: "RK3588 AI边缘计算盒", link: "/insights/rk3588-ai-edge-box" },
          { text: "HubPort系统集成", link: "/insights/hubport-system-integration" },
          { text: "HubPort工业软网关", link: "/insights/hubport-industrial-soft-gateway" },
          { text: "HubPort设备集成", link: "/insights/hubport-device-integration" },
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "一次设备与二次系统", link: "/knowledge/primary-and-secondary-systems" },
          { text: "电气间隔", link: "/knowledge/electrical-bay" },
          ...
          { text: "继电保护架构演进", link: "/knowledge/relay-protection-evolution" },
        ],
      },
      {
        text: "建设指南",
